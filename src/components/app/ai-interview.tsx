        ...
        <CardContent className="space-y-5">
              ...
              {(Object.keys(TYPE_META) as AiType[]).map((t) => (
                <button
                  ...
                  className={cn(
                    ...
                    type === t ? "border-indigo-600 bg-indigo-50 ring-1 ring-indigo-600" : "border-slate-200 bg-surface hover:border-slate-300"
                  )}
                >
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-xl border border-slate-200 bg-surface px-3 py-2 text-sm outline-none transition-colors focus:border-indigo-500 focus-visible:ring-2 focus-visible:ring-indigo-100"
              placeholder="e.g. Software Developer"
            />
          </div>
          <Button variant="default" onClick={startInterview} disabled={loadingQuestions}>
            {loadingQuestions ? (
              <>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex items-center justify-between gap-3">
          ...
          {current < questions.length - 1 ? (
            ...
            <Button variant="default" onClick={submit} disabled={submitting || !done}>
